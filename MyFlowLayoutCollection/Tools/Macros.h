...
/** 占位图 */
#define HOLDERIMAGE  [UIImage imageNamed:@"icon_holder"]

/** string turn URL */
#define URLString(urlStr)     [NSURL URLWithString:(urlStr)]
...
//全局背景色
#define HRZThemeColor       RGB(255,80,0)               //  主题颜色
#define HRZBGColor          RGB(245,245,245)            //  背景颜色
#define HRZSpaceLineColor   RGB(235,235,235)            //  间隔线颜色
...
#define UserInfoData [HRZUserInfo findAll].lastObject


//判断设备是否为iphoneX
#define HRZIsiPhoneX ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1125, 2436), [[UIScreen mainScreen] currentMode].size) : NO)
...
#define HRZXiangqing @"https://github.com/TyroneSong/SPSlideSwitch"
